...
import userService.configuration.FriendsConfiguration;
import userService.services.UserService;
import userService.services.UserServiceImpl;
...
public class FriendsServer {
	...
	public static void main(String[] args) {
		// Tell server to look for web-server.properties or user-server.yml
