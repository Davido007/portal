package com.travalo.hotelService;
import com.travalo.hotelService.configuration.HotelsConfiguration;
import com.travalo.hotelService.services.HotelService;
import com.travalo.hotelService.services.HotelServiceImpl;
...
public class HotelServer {
	...
	public static void main(String[] args) {
		// Tell server to look for web-server.properties or hotel-server.yml
		System.setProperty("spring.config.name", "hotel-server");
	 ...
	 */
	@Bean
	public HotelService hotelServiceImpl() {
