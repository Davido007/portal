...
import com.travalo.carservice.configuration.CarConfiguration;
...
public class CarServer {
	...
	public static void main(String[] args) {
		// Tell server to look for web-server.properties or car-server.yml
		System.setProperty("spring.config.name", "car-server");
